    ...
    constructor(playerNumber, x, y) {
        ...
        this.animations = {
            ...
            [FighterDirection.LEFT]: {
                ...
                [FighterState.WALK_FORWARD]: ['left_fwalk_1', 'left_fwalk_2', 'left_fwalk_3', 'left_fwalk_4', 'right_fwalk_5'],
                [FighterState.WALK_BACKWARD]: ['right_fwalk_5', 'left_fwalk_4', 'left_fwalk_3', 'left_fwalk_2', 'left_fwalk_1'],
